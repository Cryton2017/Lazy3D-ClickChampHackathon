...
export default defineMessages({
    ...
    info2: {
        ...
        defaultMessage: 'Automatically selects frames from video footage, no need for tedious frame by frame selection',
    },
    info3: {
        id: 'app.components.HomePage.info3',
        defaultMessage: 'Remove backgrounds and extra artifacts right in your browser in real time. using selection and other tools',
    },
    info4: {
